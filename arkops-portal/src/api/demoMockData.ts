...
export const demoStores: Store[] = [
  {
    id: 101, name: 'Demo 运动旗舰店', platform: '京东',
    authMethod: 'api_key', status: 'connected', runtimeProvider: 'mulerun', createdAt: '2026-07-01T00:00:00Z', recentTaskIds: [4001, 4002, 4003],
    connections: [
      { id: 1, serviceName: '京准通', serviceType: 'advertising', authMethod: 'api_key', status: 'connected', runtimeProvider: 'mulerun', createdAt: '2026-07-01T00:00:00Z' },
      { id: 2, serviceName: '咚咚客服', serviceType: 'customer_service', authMethod: 'api_key', status: 'connected', runtimeProvider: 'mulerun', createdAt: '2026-07-01T00:00:00Z' },
      { id: 3, serviceName: '京东物流', serviceType: 'logistics', authMethod: 'api_key', status: 'connected', runtimeProvider: 'mulerun', createdAt: '2026-07-01T00:00:00Z' },
      { id: 4, serviceName: '京麦财务', serviceType: 'finance', authMethod: 'api_key', status: 'connected', runtimeProvider: 'mulerun', createdAt: '2026-07-01T00:00:00Z' },
    ],
  },
  {
    id: 102, name: 'Demo 数码配件店', platform: '淘宝',
    authMethod: 'oauth', status: 'connected', runtimeProvider: 'mulerun', createdAt: '2026-07-01T00:00:00Z', recentTaskIds: [4007],
    connections: [
      { id: 5, serviceName: '直通车 / 万相台', serviceType: 'advertising', authMethod: 'oauth', status: 'connected', runtimeProvider: 'mulerun', createdAt: '2026-07-01T00:00:00Z' },
      { id: 6, serviceName: '菜鸟物流', serviceType: 'logistics', authMethod: 'oauth', status: 'connected', runtimeProvider: 'mulerun', createdAt: '2026-07-01T00:00:00Z' },
    ],
  },
];
...
export const demoTasks: Task[] = [
  { id: 4001, title: '发布新品：透气跑步鞋 AirBoost 3.0', storeId: 101, agentType: 'product_launch', goal: '完成产品上架全流程', status: 'succeeded', riskLevel: 'low', createdAt: '2026-07-09T09:30:00Z', updatedAt: '2026-07-09T09:45:00Z', timeline: [{ id: 1, type: 'run_succeeded', title: '商品已上架', summary: '已发布到 京东。', at: '2026-07-09T09:45:00Z' }] },
  ...
  { id: 4003, title: '京准通广告预算优化', storeId: 101, agentType: 'ads_optimizer', goal: '将低 ROI 广告预算转移', status: 'running', riskLevel: 'low', createdAt: '2026-07-09T10:30:00Z', updatedAt: '2026-07-09T10:30:00Z', timeline: [{ id: 1, type: 'run_started', title: '开始广告优化', summary: '正在分析近 7 天广告数据...', at: '2026-07-09T10:30:00Z' }] },
...
export const demoApprovals: Approval[] = [
  ...
  { id: 5002, taskId: 4003, storeId: 101, storeName: 'Demo 运动旗舰店', agentType: 'promotion_campaign', title: '双十一促销活动预算审批', reason: '大促预算超出日常预算 3 倍', proposedAction: '批准 ¥2,000 预算分配', beforeValue: '预算 ¥500', afterValue: '预算 ¥2,000', riskLevel: 'medium', status: 'pending', requestedAt: '2026-07-09T09:00:00Z' },
...
export function getDemoBusinessMetrics() {
  return {
    ...
    storeGmvRank: [
      { storeName: 'Demo 运动旗舰店', platform: '京东', gmv: 5210 },
      { storeName: 'Demo 数码配件店', platform: '淘宝', gmv: 3210 },
    ],
    adMetrics: {
