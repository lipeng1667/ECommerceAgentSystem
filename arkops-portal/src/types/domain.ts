 ...
 */
export type InboxItemKind = 'approval' | 'exception' | 'relogin' | 'order_exception' | 'product_draft' | 'product_new' | 'product_merge' | 'product_conflict' | 'review_pending' | 'product_stock';
